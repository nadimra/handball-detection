...
sys.path.append(os.path.join(os.getcwd()+'/project_HRNet', 'models', 'detectors', 'yolo'))
...
class YOLOv3:
    def __init__(self,
                 model_def="project_HRNet/models/detectors/yolo/config/yolov3.cfg",
                 class_path="project_HRNet/models/detectors/yolo/data/coco.names",
                 weights_path="project_HRNet/models/detectors/yolo/weights/yolov3.weights",
                 conf_thres=0.2,
                 nms_thres=0.4,
                 img_size=416,
                 classes=None,

...
from project_HRNet.models.hrnet import HRNet
from project_HRNet.models.poseresnet import PoseResNet
...
class SimpleHRNet:
    ...
    def __init__(self,
                 ...
                 max_batch_size=32,
                 yolo_model_def="project_HRNet/models/detectors/yolo/models/detectors/yolo/config/yolov3.cfg",
                 yolo_class_path="project_HRNet/models/detectors/yolo/models/detectors/yolo/data/coco.names",
                 yolo_weights_path="project_HRNet/models/detectors/yolo/models/detectors/yolo/weights/yolov3.weights",
        ...
        if self.multiperson:
            from project_HRNet.models.detectors.YOLOv3 import YOLOv3
